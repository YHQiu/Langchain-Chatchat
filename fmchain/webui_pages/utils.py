...
class ApiRequest:
    ...
    def chat_chat(
        ...
        if no_remote_api:
            from fmchain.server.chat.chat import chat
    ...
    def knowledge_base_chat(
        ...
        if no_remote_api:
            from fmchain.server.chat.knowledge_base_chat import knowledge_base_chat
    ...
    def list_running_models(
        ...
        if no_remote_api:
            from fmchain.server.llm_api import list_llm_models
    ...
    def stop_llm_model(
        ...
        if no_remote_api:
            from fmchain.server.llm_api import stop_llm_model
    ...
    def change_llm_model(
        ...
        if no_remote_api:
            from fmchain.server.llm_api import change_llm_model
